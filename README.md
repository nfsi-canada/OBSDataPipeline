...
|:--------------------:|:---------:|:-------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      `log_dir`       | `common`  | ~/resource/OBSDataPipeline/logs | Directory where run-time logs are to be saved. Will recognize `:base` and `:data` as `base_dir` and `data_dir`, respectively.                                            |
