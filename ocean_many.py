"""
Run oceanographic data analysis script (ext_pressure_analysis.py) for several instruments sequentially. Should be able
to use same format input file as field QC script (OBS_QC.py)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Run oceanographic data analysis script (ext_pressure_analysis.py) for several instruments sequentially.")
    parser.add_argument('bulk_info', type=str,
                        help="JSON file containing command-line options for script for all instruments as a "
                             "dictionary.")
